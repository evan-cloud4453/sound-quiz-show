...
export default function GameScreen() {
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(playTimer)
  }, [audioUrl, currentRound, playAudio])
        ...
        <div className="game-center">
          ...
          <div className="audio-area glass-panel">
            <div className="audio-inner">
              ...
              {audioBlocked && (
                <button className="btn btn-secondary audio-play-btn" onClick={playAudio}>
                  ▶ 재생
                </button>
              )}
              {audioError && (
                <div className="audio-error">라운드를 시작할 음원을 받을 수 없습니다.</div>
              )}
