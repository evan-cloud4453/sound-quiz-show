// ============================================================
// server/quizData.js  — 전체 50문제 세팅 완료!
// ============================================================
// YouTube IFrame API 재생 문제는 youtubeId, youtubeStart, youtubeEnd를 사용합니다.
// youtubeId는 YouTube 링크의 v 값입니다.

const RAW_QUIZ_DATA = [
  // ── 한국 드라마 OST ─────────────────────────────────────
  {
    id: 'k001', category: '한국 드라마 OST',
    youtubeId: 'aE0eV2J1Tsg', youtubeStart: 55, youtubeEnd: 65, // 태양의 후예 - Always
  ...
  },
  {
    ...
    youtubeId: 'pcKR0LPwoYs', youtubeStart: 43, youtubeEnd: 53, // 도깨비 - Stay With Me
  ...
  },
  {
    ...
    youtubeId: 'w7hXGjB0B1o', youtubeStart: 60, youtubeEnd: 70, // 별에서 온 그대 - My Destiny
  ...
  },
  {
    ...
    youtubeId: 'O0StKl0G_sU', youtubeStart: 55, youtubeEnd: 65, // 이태원 클라쓰 - 시작
  ...
  },
  {
    ...
    youtubeId: 'eIZ09pXKEP4', youtubeStart: 60, youtubeEnd: 70, // 사랑의 불시착
  ...
  },
  {
    ...
    youtubeId: 'R1h3D1PofzU', youtubeStart: 45, youtubeEnd: 55, // 응답하라 1988 - 소녀
  ...
  },
  {
    ...
    youtubeId: 'aTfT9Y-356c', youtubeStart: 50, youtubeEnd: 60, // 미스터 션샤인
  ...
  },
  {
    ...
    youtubeId: 'qHxxN7lR6cM', youtubeStart: 65, youtubeEnd: 75, // 스물다섯 스물하나 - 자우림
  ...
  },
  {
    ...
    youtubeId: '1yZ02gUls70', youtubeStart: 30, youtubeEnd: 40, // 킹덤
    hint: '조선시대 좀비 드라마',
    answers: ['킹덤', 'kingdom'],
    difficulty: 3
  },
  {
    ...
    youtubeId: 'w-c14Fz7R_o', youtubeStart: 20, youtubeEnd: 30, // 오징어 게임 - Pink Soldiers
  ...
  // ── 한국 인기가요 ────────────────────────────────────────
  {
    ...
    youtubeId: 'gdZLi9oWNZg', youtubeStart: 46, youtubeEnd: 56, // BTS - Dynamite
  ...
  },
  {
    ...
    youtubeId: 'jeqdYqsrsA0', youtubeStart: 268, youtubeEnd: 278, // 아이유 - 좋은 날 (3단 고음 파트)
  ...
  },
  {
    ...
    youtubeId: 'IHNzOHi8sJs', youtubeStart: 55, youtubeEnd: 65, // BLACKPINK - DDU-DU DDU-DU
    hint: '블랙핑크의 대표곡',
  ...
  },
  {
    ...
    youtubeId: '9bZkp7q19f0', youtubeStart: 50, youtubeEnd: 60, // PSY - 강남스타일
  ...
  },
  {
    ...
    youtubeId: 'I3dezFzx8Cg', youtubeStart: 65, youtubeEnd: 75, // EXO - 으르렁
    hint: 'EXO의 으르렁거리는 노래',
  ...
  },
  {
    ...
    youtubeId: '11cta61wi0g', youtubeStart: 50, youtubeEnd: 60, // NewJeans - Hype Boy
    hint: '뉴진스의 데뷔곡',
  ...
  },
  {
    ...
    youtubeId: 'c7rCyll5AeY', youtubeStart: 55, youtubeEnd: 65, // TWICE - CHEER UP
    hint: '트와이스의 샤샤샤 노래',
  ...
  },
  {
    ...
    youtubeId: 'MBdVXkSdhwU', youtubeStart: 75, youtubeEnd: 85, // 방탄소년단 - DNA
    hint: 'BTS의 DNA',
  ...
  },
  {
    ...
    youtubeId: '4TWR90KJl84', youtubeStart: 40, youtubeEnd: 50, // aespa - Next Level
    hint: '에스파의 넥스트 레벨',
  ...
  },
  {
    ...
    youtubeId: 'tF27TNC_4pc', youtubeStart: 55, youtubeEnd: 65, // 싸이 - 나팔바지
    hint: '싸이의 흠뻑쇼 대표곡',
    answers: ['나팔바지', '싸이', 'psy'],
    difficulty: 3
  },
  {
    ...
    youtubeId: 'AAbokV76tkU', youtubeStart: 75, youtubeEnd: 85, // 빅뱅 - 판타스틱 베이비
  ...
  },
  {
    ...
    youtubeId: 'XsX3ATc3FbA', youtubeStart: 55, youtubeEnd: 65, // 방탄소년단 - Boy With Luv
  ...
  },
  {
    ...
    youtubeId: 'TgOu00Mf3kI', youtubeStart: 60, youtubeEnd: 70, // 아이유 - Eight
    hint: '아이유 X 슈가 콜라보',
  ...
  },
  {
    ...
    youtubeId: 'Dab4EENTW5I', youtubeStart: 60, youtubeEnd: 70, // Stray Kids - MIROH
    hint: '스트레이 키즈의 마이로',
  ...
  },
  {
    ...
    youtubeId: 'J-wFp43bBXc', youtubeStart: 60, youtubeEnd: 70, // SEVENTEEN - VERY NICE
    hint: '세븐틴의 아주 Nice',
  ...
  // ── 해외 팝송 ────────────────────────────────────────────
  {
    ...
    youtubeId: 'JGwWNGJdvx8', youtubeStart: 46, youtubeEnd: 56, // Ed Sheeran - Shape of You
  ...
  },
  {
    ...
    youtubeId: '4NRXx6U8ABQ', youtubeStart: 58, youtubeEnd: 68, // The Weeknd - Blinding Lights
  ...
  },
  {
    ...
    youtubeId: '34Na4j8HLjc', youtubeStart: 60, youtubeEnd: 70, // The Weeknd - Starboy
  ...
  },
  {
    ...
    youtubeId: 'nYh-n7EOtMA', youtubeStart: 50, youtubeEnd: 60, // Sia - Cheap Thrills
  ...
  },
  {
    ...
    youtubeId: 'H5v3kku4y6Q', youtubeStart: 45, youtubeEnd: 55, // Harry Styles - As It Was
  ...
  },
  {
    ...
    youtubeId: 'ZmDBbnmKpqQ', youtubeStart: 60, youtubeEnd: 70, // Olivia Rodrigo - drivers license
  ...
  },
  {
    ...
    youtubeId: 'rYEDA3JcQqw', youtubeStart: 65, youtubeEnd: 75, // Adele - Rolling in the Deep
    hint: '아델의 복수심 가득한 노래',
  ...
  },
  {
    ...
    youtubeId: 'gl1aHhXnN1k', youtubeStart: 55, youtubeEnd: 65, // Ariana Grande - Thank U, Next
  ...
  },
  {
    ...
    youtubeId: 'b1kbLwvqugk', youtubeStart: 50, youtubeEnd: 60, // Taylor Swift - Anti-Hero
  ...
  },
  {
    ...
    youtubeId: 'DyDfgMOUjCI', youtubeStart: 72, youtubeEnd: 82, // Billie Eilish - bad guy
    hint: '빌리 아일리시의 duh~',
  ...
  },
  {
    ...
    youtubeId: 'VbfpW0pbvaU', youtubeStart: 50, youtubeEnd: 60, // Shawn Mendes - Stitches
    hint: '숀 멘데스의 상처 노래',
  ...
  },
  {
    ...
    youtubeId: 'fRh_vgS2dFE', youtubeStart: 55, youtubeEnd: 65, // Justin Bieber - Sorry
  ...
  },
  {
    ...
    youtubeId: 'PT2_F-1esPk', youtubeStart: 65, youtubeEnd: 75, // The Chainsmokers - Closer
    hint: '체인스모커스 X 홀지',
  ...
  },
  {
    ...
    youtubeId: 'TUVcZfQe-Kw', youtubeStart: 50, youtubeEnd: 60, // Dua Lipa - Levitating
    hint: '두아 리파의 우주적인 노래',
  ...
  },
  {
    ...
    youtubeId: 'OPf0YbXqDm0', youtubeStart: 58, youtubeEnd: 68, // Mark Ronson - Uptown Funk
    hint: '브루노 마스의 업타운 펑크',
  ...
  // ── 한국 영화 OST ────────────────────────────────────────
  {
    ...
    youtubeId: 'Fk99PCHieT4', youtubeStart: 20, youtubeEnd: 30, // 기생충 - 짜파구리
  ...
  // ── 해외 영화/애니 OST ───────────────────────────────────
  {
    ...
    youtubeId: 'L0MK7qz13bU', youtubeStart: 60, youtubeEnd: 70, // 겨울왕국 - Let It Go
    hint: '눈의 여왕이 부르는 노래',
  ...
  },
  {
    ...
    youtubeId: 'GibiNy4d4gc', youtubeStart: 25, youtubeEnd: 35, // 라이온킹 - Circle of Life
    hint: '아프리카 초원의 왕 이야기',
  ...
  },
  {
    ...
    youtubeId: 'Htaj3o3JD8I', youtubeStart: 20, youtubeEnd: 30, // 해리포터 OST
  ...
  },
  {
    ...
    youtubeId: 'fJ9rUzIMcZQ', youtubeStart: 45, youtubeEnd: 55, // 보헤미안 랩소디 - We Will Rock You
    hint: '퀸의 전기 영화',
